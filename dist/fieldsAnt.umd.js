(function (global, factory) {
  ...
  (global = global || self, factory(global['fields-ant'] = {}, global.React, global.autoBindMethods, global.cx, global.Antd, global.mobx, global.lodash, global.utils, global.moment, global.dateFns, global.iso8601Duration, global.mobxReact, global.SmartBool, global.flattenObject));
}(this, function (exports, React, autoBindMethods, cx, Antd, mobx, lodash, utils, moment, dateFns, iso8601Duration, mobxReact, SmartBool, flattenObject) { 'use strict';
  ...
  function (_Component) {
    ...
    _createClass(ObjectSearchCreateSearchInput, [{
      ...
      get: function get() {
        ...
        return lodash.pick(this.props.selectProps, ['clearIcon', 'placeholder', 'removeIcon', 'suffixIcon']);
      }
    }]);
    ...
    _createClass(ObjectSearchCreate, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(Antd.Form.Item, {
          className: className
        }, formManager.form.getFieldDecorator(fieldConfig.field, decoratorOptions)(React__default.createElement(ObjectSearchCreateSearchInput, _extends({
