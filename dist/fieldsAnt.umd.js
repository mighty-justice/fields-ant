(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'mobx-react', 'lodash', 'antd', 'mobx', '@mighty-justice/utils', 'moment', 'date-fns', 'iso8601-duration', 'class-autobind-decorator', 'classnames', '@mighty-justice/smart-bool', 'flat'], factory) :
  (global = global || self, factory(global['fields-ant'] = {}, global.React, global.mobxReact, global.lodash, global.Antd, global.mobx, global.utils, global.moment, global.dateFns, global.iso8601Duration, global.autoBindMethods, global.cx, global.SmartBool, global.flatten));
}(this, function (exports, React, mobxReact, lodash, Antd, mobx, utils, moment, dateFns, iso8601Duration, autoBindMethods, cx, SmartBool, flatten) { 'use strict';
