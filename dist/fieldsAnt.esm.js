...
var UnwrappedForm = autoBindMethods(_class$e = observer(_class$e = (_class2$b = (_temp$3 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(UnwrappedForm, [{
    ...
    value: function render() {
      ...
      return React.createElement(Form, {
        ...
        className: "mfa-form"
      }, title && React.createElement("h2", null, title), this.fieldSets.map(function (fieldSet, idx) {
        return React.createElement(Fragment, {
          key: idx
        }, idx > 0 && React.createElement(Divider, {
          key: "divider-".concat(idx)
...
var FormCard = autoBindMethods(_class$f = observer(_class$f = (_temp$4 = _class2$c =
/*#__PURE__*/
function (_Component) {
...
}), _descriptor2$2 = _applyDecoratedDescriptor(_class2$d.prototype, "isEditing", [observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var FormDrawer = autoBindMethods(_class$i = observer(_class$i = (_temp$7 = _class2$f =
/*#__PURE__*/
function (_Component) {
