import React__default, { Component, createContext, useContext, useEffect, forwardRef, createElement } from 'react';
...
var ButtonToolbar = autoBindMethods(_class = observer(_class = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ButtonToolbar, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Form$1.Item, _extends({}, passDownProps, {
        className: className
      }), this.props.children);
    }
  }]);
...
var Address = autoBindMethods(_class$2 = observer(_class$2 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Address, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Col, colProps, /*#__PURE__*/React__default.createElement(Form$1.Item, {
        className: className
...
var DeleteOutlined$2 = /*#__PURE__*/forwardRef(DeleteOutlined$1);
...
var LoadingOutlined$2 = /*#__PURE__*/forwardRef(LoadingOutlined$1);
...
var QuestionCircleOutlined$2 = /*#__PURE__*/forwardRef(QuestionCircleOutlined$1);
...
var ObjectSearch = (_dec = inject('getEndpoint'), _dec(_class$3 = autoBindMethods(_class$3 = observer(_class$3 = (_class2$1 = (_temp$1 = _class3 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ObjectSearch, [{
    ...
    value: function renderNoResultsOption() {
      ...
      }, /*#__PURE__*/React__default.createElement("div", null, get(selectProps, 'notFoundContent') || 'No results'));
    }
  }, {
...
var ObjectSearchCreate = autoBindMethods(_class$4 = observer(_class$4 = (_class2$2 = (_temp$2 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ObjectSearchCreate, [{
    ...
    value: function renderAddNew() {
      ...
      return /*#__PURE__*/React__default.createElement(Col, null, /*#__PURE__*/React__default.createElement(Form$1.Item, null, /*#__PURE__*/React__default.createElement(NestedFieldSet, {
...
var WithTooltip = autoBindMethods(_class$5 = observer(_class$5 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(WithTooltip, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("span", null, children, "\xA0", /*#__PURE__*/React__default.createElement(Tooltip, {
        title: tooltip
...
var Date = autoBindMethods(_class$6 = observer(_class$6 = (_temp$3 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Date, [{
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default.createElement(Input.Group, {
        compact: true
...
var RadioGroup = (_dec$2 = inject('getOptions'), _dec$2(_class$9 = autoBindMethods(_class$9 = observer(_class$9 = (_class2$4 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(RadioGroup, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default.createElement(Radio.Group, this.props, this.options.map(function (option) {
...
function formatRating(value) {
  return value ? /*#__PURE__*/React__default.createElement(Rate$1, {
    disabled: true,
    defaultValue: +value
  }) : EMPTY_FIELD;
}
...
var Rate = autoBindMethods(_class$a = observer(_class$a = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Rate, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default.createElement(Rate$1, _extends({}, this.props, {
...
var Checkbox = autoBindMethods(_class$d = observer(_class$d = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement("span", null, /*#__PURE__*/React__default.createElement(Checkbox$1, checkboxProps, description || '')));
    }
  }, {
    key: "injected",
    get: function get() {
...
function assignErrorFieldsToFormFields(fieldNames, fieldErrors) {
  ...
  Object.keys(fieldErrors).forEach(function (errorField) {
    var message = fieldErrors[errorField],
        label = errorField === 'non_field_errors' ? '' : varToLabel(errorField); // Check for an exact match
...
var FieldSet = autoBindMethods(_class$k = observer(_class$k = (_temp$8 = _class2$b = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FieldSet, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default.createElement(Row, _extends({}, rowProps, {
  ...
  _createClass(GuardedButton, [{
    ...
    value: function render() {
      ...
      if (this.props.confirm) {
        ...
        return /*#__PURE__*/React__default.createElement(Popconfirm, {
          title: "Are you sure?",
          onConfirm: this.props.onClick
        }, /*#__PURE__*/React__default.createElement(GuardedContainer, omit(this.props, omitProps)));
      }

      return /*#__PURE__*/React__default.createElement(GuardedContainer, omit(this.props, omitProps));
    }
  }]);
...
var Card = autoBindMethods(_class$p = observer(_class$p = (_class2$f = (_temp$a = _class3$4 = /*#__PURE__*/function (_Component) {
  ...
  return Card;
}(Component), _class3$4.defaultProps = _objectSpread2({}, cardPropsDefaults), _temp$a), (_applyDecoratedDescriptor(_class2$f.prototype, "fieldSets", [computed], Object.getOwnPropertyDescriptor(_class2$f.prototype, "fieldSets"), _class2$f.prototype)), _class2$f)) || _class$p) || _class$p;
  ...
  _createClass(ArrayCard, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Card$1, {
        ...
        extra: renderTopRight && renderTopRight(),
        loading: isLoading
      }, isEmpty(model) && /*#__PURE__*/React__default.createElement("p", {
  ...
  _createClass(UnwrappedForm, [{
    ...
    value: function renderControls() {
      ...
      return /*#__PURE__*/React__default.createElement(ButtonToolbar, {
        ...
        onClick: onCancel,
        size: "large"
      }, cancelText), /*#__PURE__*/React__default.createElement(Button, submitProps));
    }
  }, {
    key: "render",
    value: function render() {
...
var EditableArrayCard = autoBindMethods(_class$u = observer(_class$u = (_class2$j = (_temp$e = _class3$6 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EditableArrayCard, [{
    ...
    value: function render() {
      ...
      }), isEmpty(model) && !this.isAddingNew.isTrue && /*#__PURE__*/React__default.createElement("p", {
        className: "empty-message"
      }, "No records"), model.map(function (modelItem) {
...
}(Component), _class3$6.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$e), (_descriptor$5 = _applyDecoratedDescriptor(_class2$j.prototype, "isAddingNew", [observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var FormDrawer = autoBindMethods(_class$v = observer(_class$v = (_temp$f = _class2$k = /*#__PURE__*/function (_Component) {
  ...
  return FormDrawer;
}(Component), _class2$k.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$f)) || _class$v) || _class$v;

var _class$w, _class2$l, _descriptor$6, _class3$7, _temp$g;
var CLASS_NAME$8 = "".concat(CLASS_PREFIX, "-form-modal");

var FormModal = autoBindMethods(_class$w = observer(_class$w = (_class2$l = (_temp$g = _class3$7 = /*#__PURE__*/function (_Component) {
  ...
  return FormModal;
}(Component), _class3$7.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$g), (_descriptor$6 = _applyDecoratedDescriptor(_class2$l.prototype, "formManager", [observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var SummaryCard = autoBindMethods(_class$x = observer(_class$x = (_class2$m = (_temp$h = _class3$8 = /*#__PURE__*/function (_Component) {
  ...
  return SummaryCard;
}(Component), _class3$8.defaultProps = {
  column: 4
}, _temp$h), (_applyDecoratedDescriptor(_class2$m.prototype, "fieldSets", [computed], Object.getOwnPropertyDescriptor(_class2$m.prototype, "fieldSets"), _class2$m.prototype)), _class2$m)) || _class$x) || _class$x;
...
var Table = autoBindMethods(_class$y = observer(_class$y = (_class2$n = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Table, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement(Table$1, _extends({}, passDownProps, {
