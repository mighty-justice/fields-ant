...
var FormManager = autoBindMethods(_class$d = (_class2$5 = (_temp$3 =
/*#__PURE__*/
function () {
  ...
  return FormManager;
}(), _temp$3), (_descriptor$2 = _applyDecoratedDescriptor(_class2$5.prototype, "saving", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var _class$e, _class2$6, _class3$1;
var CARD_COL_LABEL = 8;
var CARD_COL_VALUE = 16;

var Info = autoBindMethods(_class$e = mobxReact.observer(_class$e =
/*#__PURE__*/
function (_Component) {
...
var Label = autoBindMethods(_class2$6 = mobxReact.observer(_class2$6 =
/*#__PURE__*/
...
var _class$f, _class2$7;

var CardField = autoBindMethods(_class$f = mobxReact.observer(_class$f = (_class2$7 =
/*#__PURE__*/
function (_Component) {
  ...
  return CardField;
}(React.Component), (_applyDecoratedDescriptor(_class2$7.prototype, "fieldConfig", [mobx.computed], Object.getOwnPropertyDescriptor(_class2$7.prototype, "fieldConfig"), _class2$7.prototype)), _class2$7)) || _class$f) || _class$f;

var _class$g, _class2$8;

var FormField = autoBindMethods(_class$g = mobxReact.observer(_class$g = (_class2$8 =
/*#__PURE__*/
function (_Component) {
...
var Legend = autoBindMethods(_class$h = mobxReact.observer(_class$h =
/*#__PURE__*/
function (_Component) {
...
var FormFieldSet = autoBindMethods(_class$i = mobxReact.observer(_class$i = (_class2$9 =
/*#__PURE__*/
function (_Component) {
  ...
  return FormFieldSet;
}(React.Component), (_applyDecoratedDescriptor(_class2$9.prototype, "fieldSet", [mobx.computed], Object.getOwnPropertyDescriptor(_class2$9.prototype, "fieldSet"), _class2$9.prototype)), _class2$9)) || _class$i) || _class$i;

var _class$j, _temp$4;

var GuardedButton = autoBindMethods(_class$j = mobxReact.observer(_class$j = (_temp$4 =
/*#__PURE__*/
function (_Component) {
...
}(React.Component), _temp$4)) || _class$j) || _class$j;

var _class$k, _class2$a;

var NestedFieldSet = autoBindMethods(_class$k = mobxReact.observer(_class$k = (_class2$a =
/*#__PURE__*/
function (_Component) {
...
var CardFieldSet = autoBindMethods(_class$l = mobxReact.observer(_class$l = (_class2$b =
/*#__PURE__*/
function (_Component) {
...
var Card = autoBindMethods(_class$m = mobxReact.observer(_class$m = (_class2$c =
/*#__PURE__*/
function (_Component) {
  ...
  return Card;
}(React.Component), (_applyDecoratedDescriptor(_class2$c.prototype, "fieldSets", [mobx.computed], Object.getOwnPropertyDescriptor(_class2$c.prototype, "fieldSets"), _class2$c.prototype)), _class2$c)) || _class$m) || _class$m;

var _class$n;

var ArrayCard = autoBindMethods(_class$n = mobxReact.observer(_class$n =
/*#__PURE__*/
function (_Component) {
...
var _class$o, _class2$d, _temp$5, _class4, _class5, _temp2;
var UnwrappedForm = autoBindMethods(_class$o = mobxReact.observer(_class$o = (_class2$d = (_temp$5 =
/*#__PURE__*/
function (_Component) {
...
}(React.Component), _temp$5), (_applyDecoratedDescriptor(_class2$d.prototype, "fieldSets", [mobx.computed], Object.getOwnPropertyDescriptor(_class2$d.prototype, "fieldSets"), _class2$d.prototype)), _class2$d)) || _class$o) || _class$o; // istanbul ignore next
...
var _class$p, _class2$e, _temp$6;
var FormCard = autoBindMethods(_class$p = mobxReact.observer(_class$p = (_temp$6 = _class2$e =
/*#__PURE__*/
function (_Component) {
  ...
  return FormCard;
}(React.Component), _class2$e.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$6)) || _class$p) || _class$p;

var _class$q, _class2$f, _descriptor$3, _descriptor2$2, _class3$2, _temp$7;

var EditableCard = autoBindMethods(_class$q = mobxReact.observer(_class$q = (_class2$f = (_temp$7 = _class3$2 =
/*#__PURE__*/
function (_Component) {
  ...
  return EditableCard;
}(React.Component), _class3$2.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$7), (_descriptor$3 = _applyDecoratedDescriptor(_class2$f.prototype, "isDeleting", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor2$2 = _applyDecoratedDescriptor(_class2$f.prototype, "isEditing", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var _class$r, _class2$g, _descriptor$4, _class3$3, _temp$8;

var EditableArrayCard = autoBindMethods(_class$r = mobxReact.observer(_class$r = (_class2$g = (_temp$8 = _class3$3 =
/*#__PURE__*/
function (_Component) {
...
}(React.Component), _class3$3.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$8), (_descriptor$4 = _applyDecoratedDescriptor(_class2$g.prototype, "isAddingNew", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
var _class$s, _class2$h, _temp$9;

var FormDrawer = autoBindMethods(_class$s = mobxReact.observer(_class$s = (_temp$9 = _class2$h =
/*#__PURE__*/
function (_Component) {
  ...
  return FormDrawer;
}(React.Component), _class2$h.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$9)) || _class$s) || _class$s;

var _class$t, _class2$i, _descriptor$5, _class3$4, _temp$a;

var FormModal = autoBindMethods(_class$t = mobxReact.observer(_class$t = (_class2$i = (_temp$a = _class3$4 =
/*#__PURE__*/
function (_Component) {
  ...
  return FormModal;
}(React.Component), _class3$4.defaultProps = _objectSpread2({}, formPropsDefaults), _temp$a), (_descriptor$5 = _applyDecoratedDescriptor(_class2$i.prototype, "formManager", [mobx.observable], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var _class$u, _class2$j, _class3$5, _temp$b;

var SummaryCard = autoBindMethods(_class$u = mobxReact.observer(_class$u = (_class2$j = (_temp$b = _class3$5 =
/*#__PURE__*/
function (_Component) {
  ...
  column: 4
}, _temp$b), (_applyDecoratedDescriptor(_class2$j.prototype, "fieldSets", [mobx.computed], Object.getOwnPropertyDescriptor(_class2$j.prototype, "fieldSets"), _class2$j.prototype)), _class2$j)) || _class$u) || _class$u;
